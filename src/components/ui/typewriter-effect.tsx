                            ...
                            {word.text.map((char, index) => (
                                <motion.span
                                    ...
                                    className={cn(`opacity-0 hidden`, word.className,
                                        "text-3xl md:text-7xl font-bold bg-gradient-to-r from-indigo-300 via-purple-400 to-pink-200 bg-clip-text text-transparent leading-tight md:leading-normal w-full text-center")}>
                                    {char}
                                </motion.span>
                            ))}
                        </div>
